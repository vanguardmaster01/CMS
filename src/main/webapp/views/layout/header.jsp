...
<html
    ...
    class="history svg video supports boxshadow csstransforms3d csstransitions backgroundcliptext webkit chrome win js sticky-header-enabled sticky-header-active">
    <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link
            rel="shortcut icon"
            href="https://www.okler.net/previews/porto/9.9.3/img/favicon.ico"
            type="image/x-icon">
        <link
            rel="apple-touch-icon"
            href="https://www.okler.net/previews/porto/9.9.3/img/apple-touch-icon.png">
        ...
        <link
            rel="stylesheet"
            href="/public/front/css/animate.compat.css">
        <link
            rel="stylesheet"
            href="/public/front/css/simple-line-icons.min.css">
        ...
        <link
            rel="stylesheet"
            href="/public/front/css/theme.css">
        <link
            rel="stylesheet"
            href="/public/front/css/theme-elements.css">

            <!-- Demo CSS -->
        <link
            rel="stylesheet"
            href="/public/front/css/demo-cleaning-services.css">
        ...
        <link
            id="skinCSS"
            rel="stylesheet"
            href="/public/front/css/skin-cleaning-services.css">
                            ...
                            <div class="header-column">
                                <div class="header-row">
                                    <div class="header-logo" style="width: 123px; height: 33px;">
                                        <a
                                            href="https://www.okler.net/previews/porto/9.9.3/demo-cleaning-services.html">
                                            <img
                                                src="#"
                                                class="img-fluid"
                                                width="123"
                                                height="32"
                                                alt="CMS"
                                                style="top: 0px; width: 123px; height: 32px;">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="header-row">
                                                    ...
                                                    <li>
	                                                    <c:choose>
														    <c:when test="${type == 0}">
														        <a
		                                                            href="<%=WebUrl.create%>"
		                                                            class="nav-link active current-page-active">Create</a>
														    </c:when>    
														    <c:otherwise>
														        <a
		                                                            href="<%=WebUrl.create%>"
		                                                            class="nav-link current-page-active">Create</a>
														    </c:otherwise>   
														</c:choose>
                                                    </li>
                                                    <li>
	                                                    <c:choose>
														    <c:when test="${type == 1}">
														        <a
		                                                            href="<%=WebUrl.blogs%>"
		                                                            class="nav-link active current-page-active">Post</a>
														    </c:when>    
														    <c:otherwise>
														        <a
		                                                            href="<%=WebUrl.blogs%>"
		                                                            class="nav-link current-page-active">Post</a>
														    </c:otherwise>   
														</c:choose>                                                    
                                                    </li>
                                                    <li>
	                                                    <c:choose>
														    <c:when test="${type == 2}">
														        <a
		                                                            href="<%=WebUrl.users%>"
		                                                            class="nav-link active current-page-active">Users</a>
														    </c:when>    
														    <c:otherwise>
														        <a
		                                                            href="<%=WebUrl.users%>"
		                                                            class="nav-link current-page-active">Users</a>
														    </c:otherwise>   
														</c:choose>                                                    
                                                    </li>
                                                </ul>
                                    ...
                                    <div class="feature-box feature-box-style-2 align-items-center ms-lg-4">
                                        <div class="feature-box-icon d-none d-sm-inline-flex">
                                            <div
                                                ...
                                                <svg
                                                    ...
                                                    id="icon_131693362527825"
                                                    data-filename="phone.svg"
                                                    width="48"
                                                    height="48">
                                                    <style type="text/css">
                                                        .st0 {
                                        ...
                                        <div class="feature-box-info ps-2">
                                            ...
                                            <a
                                                href="tel:+1234567890"
                                                class="text-color-tertiary text-color-hover-primary text-decoration-none font-weight-bold line-height-1 custom-font-size-1 pb-0">123-456-7890</a>
                                        </div>
                                    </div>
                                    <button
